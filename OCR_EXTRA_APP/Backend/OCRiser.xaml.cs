...
{
    /// <summary>
    /// Interaction logic for OCRiser.xaml
    /// </summary>
    public partial class OCRiser : Window
    {
        ...
        #region constructeur pour recuperer le id lot de la page ocrisation
        public OCRiser(string id_lot) : this()
        {
